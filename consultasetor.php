	...
	<body>
		...
		<div class="row">
			<div class="col s12 m8 push-m2">
				...
				<h4 class="light"> SETORES CADASTRADOS </h4>
				<table class="striped">
					<thead>
						<tr>							
							<th>SETOR</th>
					...
					<tbody>
						...
						function convertedata($data)
						{
							...
							$sql = "SELECT id, descricao, datainicial, ativo FROM tb_setoresprodutivos order by descricao";
							...
							if(mysqli_num_rows($resultado) > 0)
							{
								...
								{								
									echo "<tr>";
										...
										echo "<td align = 'center'>".convertedata($dados['datainicial'])."</td>";
										if ($dados['ativo'] = 1)
										{
											$imagem = 'checado.jpg';
										} 
										...
										echo "<td align = 'center'><a href = 'alterar.php?id=$id'>VISUALIZAR</a>";						
				...
				<br>
				<a href="cadsetor.php" class="btn">CADASTRAR SETOR PRODUTIVO</a>
				<a href="index.html" class="btn">VOLTAR</a>
			</div>
		</div>
