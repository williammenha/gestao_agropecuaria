  ...
  <body>
    <form class="form-signin" action = "incluirtipo.php" method = "post">
        <?php
            ...
            $datainicial = utf8_decode(mb_strtoupper(filter_input(INPUT_POST, 'txtDatainicial', FILTER_SANITIZE_STRING)));
            ...
            $ativo = 1;
            $sqlinsert = "INSERT INTO tb_setoresprodutivos (descricao, datainicial, id_tipo, observacao, ativo) values ('$descricao', '$datainicial', $tipo, '$observacao', $ativo)";
            ...
            echo '<meta http-equiv="refresh" content="2;URL=cadsetor.php" />';
            echo '<br><br><h3>Retornando à página de cadastro!</h3>';
        ?> 
    </form>
  </body>
</html>