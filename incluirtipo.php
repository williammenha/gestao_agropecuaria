  ...
  <body>
    <form class="form-signin" action = "incluirtipo.php" method = "post">
         ...
         <?php
            ...
            $tipo = utf8_decode(mb_strtoupper(filter_input(INPUT_POST, 'txtTipo', FILTER_SANITIZE_STRING)));
            $observacao = utf8_decode(mb_strtoupper(filter_input(INPUT_POST, 'txtObservacao', FILTER_SANITIZE_STRING)));
            $ativo = 1;

            $sqlinsert = "INSERT INTO tb_tipo(descricao, observacao, ativo) VALUES ('$tipo', '$observacao', $ativo)";
            ...
            echo '<meta http-equiv="refresh" content="2;URL=cadtipo.html" />';
