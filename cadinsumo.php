...
<html lang="en">
  ...
  <body>
    <form class="form-signin" action = "incluirinsumo.php" method = "post">

      <div class="text-center mb-4">
        <h1 class="h3 mb-3 font-weight-normal">CADASTRO DE INSUMOS</h1>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-mb-4">
          <input id="txtDescricao" name="txtDescricao" type="text" placeholder="digite a descricao do insumo" class="form-control input" required="" style="text-transform: uppercase;">       
        </div>
      </div>     
      <!-- Select Basic -->
      <div class="form-group">
      ...
      <a class="btn btn-lg btn-primary btn-block" href="consultainsumo.php">VOLTAR</a>
